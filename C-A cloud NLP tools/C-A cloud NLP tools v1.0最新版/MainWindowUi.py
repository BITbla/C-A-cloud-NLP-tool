...
class LeftTabWidget(QWidget):
    ...
    def openFile(self):
        ...
        self.uploadFileAtWorkSpace2(openfile_name)
        return openfile_name

    def uploadFileAtWorkSpace2(self, fullpath):
        path, filename = getPathAndFile(fullpath)
        ext = getExt(fullpath)
        if (ext == '.jpg' or ext == '.png' or ext == '.JPG' or ext == '.PNG' or ext == '.txt'):
    ...
    def openPhoto(self):
        ...
        if (ext == '.jpg' or ext == '.png' or ext == '.JPG' or ext == '.PNG'):
            ...
            self.serve.uploadFileAtWorkSpace(self.userControl.getUsername(),getPath(openfile_name), getFile(openfile_name))
...
#
#     main_wnd = LeftTabWidget('test2','test2')
#     main_wnd.show()
#
#     # win = MainWindow()
#     # win.show()
